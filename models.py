...
class LSTMTagger(nn.Module):
    ...
    def forward(self, sentence, char_emb):
        #cat = torch.cat(sentence, char_emb)
        
        #print(sentence, char_emb)
        embeds = self.word_embeddings(sentence)
        #embeds_char = self.word_embeddings(char_rep_seq)
        embeds = torch.cat([embeds, char_emb], 1)
